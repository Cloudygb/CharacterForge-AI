...
$ToolName = "aws-cli-v2"
$DownloadUrl = "https://awscli.amazonaws.com/AWSCLIV2-2.34.53.msi"
$InstallerFileName = "AWSCLIV2.msi"
$InstallerVersion = "2.34.53"
$ExpectedSha256 = "5121640ad936b07ed42d01bf4df78ff4f5286bf912f6a855f0a7be921801fc56"
...
try {
    ...
    if ($DryRun) {
        Write-CharacterForgeAILog "Dry-run mode: would download pinned AWS CLI v2 2.34.53 and run quiet MSI install."
